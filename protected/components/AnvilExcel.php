...
class AnvilExcel{
	public static function StandardExcel($temp_table,$reportname,$linkurl,$currency,$adtypes,$period){
		...
		if($stored_stations = Yii::app()->db3->createCommand($station_sql)->queryAll()){
			...
			->setCellValue('A1', "Reelforge Proof of Flight Report For The Period $period")
