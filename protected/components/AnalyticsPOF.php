...
class AnalyticsPOF{
	public static function CompetitorReport($startdate,$enddate,$brand_query,$country_id,$station_query,$ad_query){
		...
		$file = AnalyticsPOF::CompetitorCompanies($temp_table,$currency,$linkurl,$period);
		return $file;

	}

	public static function CompetitorCompanies($temp_table,$currency,$linkurl,$period){
		...
		->setCellValue('A2', "Electronic Summary For The Period $period")
		->setCellValue('A3', ' ')
