...
$this->pageTitle=Yii::app()->name.' | Industry Summary';
$this->breadcrumbs=array('Industry Summary'=>array('misc/industrysummary'));
?>
...
<div id="wid-id-0" class="jarviswidget jarviswidget-sortable"style="" role="widget">
	<header role="heading"><h2>Industry Summary Reports </h2></header>
	<div role="content">
