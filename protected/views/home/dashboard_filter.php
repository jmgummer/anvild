...
<div id="wid-id-0" class="jarviswidget jarviswidget-sortable"style="" role="widget">
	<header role="heading"><h2>Weekly Trend Report</h2></header>
	<div role="content">
		...
		<fieldset>
			<p><i>This is a 4 week trend analysis for the selected media and industries within a given period of time.</i></p>
			...
			<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="regular">
						<header role="heading">Week Ending </header>
						<label class="input">
							<?php echo $form->textField($model,'startdate',array('size'=>60,'maxlength'=>60, 'class'=>'form-control', 'name'=>'startdate','required'=>'required')); ?>
						</label>
					</div>
				</div>
			</div>
		...
		<?php
		// $trend = DashboardCharts::RenderTrend();
