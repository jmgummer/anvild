<?php
$this->pageTitle=Yii::app()->name.' | Media House Activity Log';
$this->breadcrumbs=array('Media House Activity Log'=>array('qc/stationlog'));
?>
...
<div id="wid-id-0" class="jarviswidget jarviswidget-sortable"style="" role="widget">
	<header role="heading"><h2>Media House Activity Log - Please Select a Station, Ad Type & Date</h2></header>
	<div role="content">
...
<div class="">
	...
	if(isset($_POST['startdate']) && $error_message==''){
		...
		$stationlog = $logs->GetLogs($set_stations,$set_adtypes,$startdate,$enddate,$reportformat);
		// var_dump($stationlog);
	}else{
		echo $error_message;
	}
