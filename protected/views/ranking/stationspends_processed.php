...
$this->pageTitle=Yii::app()->name.' | Agency Spends By Station';
$this->breadcrumbs=array('Agency Spends By Station'=>array('ranking/stationspends'));
?>
...
*/
$results = StationSpends::TotalStationSpends($agency_id,$enddate,$startdate,$sqlstartdate,$sqlenddate,$set_brands);
