		...
		<div class="row-fluid clearfix">
			...
			<div class="col-md-3">
				<div class="padleft">
					...
					'data'=>array('subindustry'=>'js:this.value'),'url'=>CController::createURL('competitor/getdata'),'update'=>'#brands',),
			...
			<div class="col-md-3">
				<div class="padleft">
					<?php
					echo $form->textFieldRow($model,'startdate',array('class'=>'form-control','name'=>'startdate','required'=>'required'));
					?>
				</div>
			</div>
			<div class="col-md-3">
				<div class="padleft">
					<?php
					echo $form->textFieldRow($model,'enddate',array('class'=>'form-control','name'=>'enddate','required'=>'required'));
					?>
				</div>
			</div>
