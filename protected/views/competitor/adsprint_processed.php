...
if($stored_companies = Yii::app()->db3->createCommand($sql_companies)->queryAll()){
	...
	$cd_name = $agency_id . "_compilation_print_".$azipfilename;
	...
	foreach ($stored_companies as $key) {
		...
		$tabledata = Ads::PrintCompanyAds($this_company_id,$sub_industry_query,$sqlstartdate,$sqlenddate,$this_company_name);
