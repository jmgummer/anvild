...
<div id="wid-id-0" class="jarviswidget jarviswidget-sortable"style="" role="widget">
	<header role="heading"><h2>Competitor Ads - Electronic Media</h2></header>
	<div role="content">
		...
		<fieldset>
			<p><i>This query aggregates all the electronic clips for the search period and generates a zipped file with a summary listing and the files.</i></p>
