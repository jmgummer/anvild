...
* @since       July 2008
*/
$this->pageTitle=Yii::app()->name.' | Competitor Ads - Print Media ';
$this->breadcrumbs=array('Competitor Ads - Print Media '=>array('competitor/adsprint'));
...
<div id="wid-id-0" class="jarviswidget jarviswidget-sortable"style="" role="widget">
	<header role="heading"><h2>Competitor Ads - Print Media</h2></header>
	<div role="content">
		...
		<fieldset>
			<p><i>This query aggregates all the print clippings for the search period and generates a zipped file with a summary listing and the files.</i></p>
